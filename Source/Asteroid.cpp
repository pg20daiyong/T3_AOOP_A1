...
void Asteroid::Initialize()
{
    ...
    auto squareWithinSquareRendering = GetComponent<SquareWithinSquareRenderingComponent>(ComponentType::SquareWithinSquareRendering);
    squareWithinSquareRendering->SetColor(exColor(77, 38, 0));
